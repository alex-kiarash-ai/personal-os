...
# soffice from env override or PATH; the hardcoded Program Files literal is gone with the
# platform (portability P5, 2026-08-25). Install LibreOffice or set ALEX_SOFFICE to the binary.
SOFFICE = os.environ.get('ALEX_SOFFICE') or shutil.which('soffice') or 'soffice'
