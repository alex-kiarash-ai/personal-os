...
description: >-
  Expert guide for n8n-mcp MCP tools (node search, validation, templates, workflow ops). Use ONLY when n8n-mcp MCP tools are available in the session; for REST-API workflow edits use n8n-workflow-patterns and n8n-node-configuration instead.
---
