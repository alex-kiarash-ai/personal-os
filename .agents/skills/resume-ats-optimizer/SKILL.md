...
description: >-
  Optimize CV content for Applicant Tracking Systems: compatibility, keyword match, screening survival. Use when tailoring CVs (#03/#14 writer prompts, #21) or when ATS/parsing is mentioned. Distinct from resume-builder (Reactive Resume JSON generator).
---
