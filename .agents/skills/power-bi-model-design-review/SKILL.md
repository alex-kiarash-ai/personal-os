...
description: >-
  Power BI data model design review: architecture, relationships, star schema, optimization. Use when designing or reviewing a semantic model, planning model changes, or prepping model-design interview answers.
---
