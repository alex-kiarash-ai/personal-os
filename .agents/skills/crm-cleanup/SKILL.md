...
name: crm-cleanup
description: >-
  CRM hygiene sweep methodology: stale records, duplicate contacts, missing fields; owner approves fixes. Written for HubSpot - apply it to the vault/people + Notion CRM during the #05 Monday run. Use when cleaning or auditing CRM data.
