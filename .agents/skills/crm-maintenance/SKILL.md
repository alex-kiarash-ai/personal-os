...
description: >-
  Keep the CRM current from email and calendar context: create/update contacts, log interactions, flag stale records. Written for HubSpot - apply to vault/people + Notion (#05). Use when updating the CRM or filing relationship context.
---
