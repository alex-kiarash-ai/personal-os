...
description: >-
  Power BI DAX optimization expertise (performance, readability, maintainability). Use when writing or reviewing DAX measures or calculated columns, tuning slow DAX, or drilling DAX answers for interviews. Pairs with the powerbi-modeling MCP tools.
---
