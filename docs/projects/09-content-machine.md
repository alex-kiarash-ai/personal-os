...
## Why it exists
The pivot needs a public presence - recruiters and STEMPLICITY clients both check the feed before they reply. But content production is exactly the kind of repeatable, judgment-plus-craft work this system is built to compress. The three-role split exists because one AI doing everything drifts generic; separate research, voice, and editing stay sharp. Nothing publishes itself: the machine produces, Shaheen posts.

## Works together with
- **[LinkedIn Series](12-linkedin-series.md)** - shares the Content Library database; the series is the flagship content stream.
- **vault/research/** - research runs become content raw material.
- **soul.md** - the Writer's voice source; the Editor enforces it.
- **[Alex AI Radar](15-alex-ai-radar.md)** - its content-angle tap suggests topics straight into this pipeline.
