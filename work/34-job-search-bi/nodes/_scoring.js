...
function rubric(L) {
  ...
  return [
    ...
    '',
    'THE LANGUAGE THE POSTING IS WRITTEN IN',
    'Report the language of the posting BODY as posting_language, lower case and named in English.',
    'If it is one he reads, say "english", "swedish" or "arabic". If it is anything else, NAME IT:',
    '"german", "french", "polish", "spanish", "dutch", and so on. Do not answer "other"; the name is',
    'the point, because it is what tells him which languages he is losing postings to.',
    'Judge the body text, not the company location and not the job title alone. A body that is mostly',
    'English is "english" even when the title or a heading is not.',
    'Return "unknown" ONLY when there is too little text to tell.',
    'This is a REPORT, not a judgement. Do NOT change fit_score because of it, and do not raise a red',
    'flag for it. The pipeline decides what to do with the answer.',
    '',
    'RED FLAGS',
    ...
    '  "posting_language": "english" | "swedish" | "arabic" | "unknown" | <the language name>',
    '}',
