...
| [technical-evaluation-internal-audit-stack-scan](technical-evaluation-internal-audit-stack-scan.md) | technical-evaluation | 2 | "Build X on our own system: what of ours feeds it + what infra signals exist + best external tooling?" Two Explore audit lanes (projects, infra) + one web Stack Scout given an explicit hypothesis to falsify. Synthesizer ranks v1 vs bench and resolves flags with documented judgment calls. Also fits designing a missing system layer (reuse 2: Recovery). |
