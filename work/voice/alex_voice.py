...
you talk, Alex talks back, you can cut her off with Esc, and it loops.
...
TTS_VOICE = "sage"              # calm/wise, matches Alex (only used when TTS_BACKEND="openai")
TTS_INSTRUCTIONS = ("Speak as Alex: calm, incisive, warm but direct, with dry wit. "
...
def main():
    ...
    print("  Esc   = cut Alex off while she's speaking")
