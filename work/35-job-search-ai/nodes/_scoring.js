...
function rubric(L) {
  ...
  return [
    ...
    'Report the language of the posting BODY as posting_language, one of "english", "swedish",',
    '"arabic", "other", or "unknown". Judge the body text, not the company location and not the job',
    'title alone. A body that is mostly English is "english" even when the title or a heading is not.',
    'Return "unknown" when there is too little text to tell.',
    ...
    '  "posting_language": "english" | "swedish" | "arabic" | "other" | "unknown"',
    '}',
